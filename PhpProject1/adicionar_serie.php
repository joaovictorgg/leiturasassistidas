...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "INSERT INTO series (titulo, diretor, ano_lancamento, genero, assistido, nota, usuario_id) VALUES ('$titulo', '$diretor', '$ano_lancamento', '$genero', '$assistido', '$nota', '$usuario_id')";
    if (mysqli_query($conexao, $query)) {
        header("Location: crud_series.php");
    } else {
        echo "Erro ao adicionar série: " . mysqli_error($conexao);
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Adicionar Série - LeiturasAssistidas</title>
