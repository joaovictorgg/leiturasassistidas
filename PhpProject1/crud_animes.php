...
$query = "SELECT * FROM animes WHERE usuario_id='$usuario_id'";
...
<head>
    ...
    <title>Gerenciar Animes - LeiturasAssistidas</title>
...
<body>
    <div class="container">
        <h1 style="color: #000">Gerenciar Animes</h1>
        <p>Nesta página, você pode visualizar, editar e excluir os animes que estão cadastrados no sistema.</p>
        ...
        <table>
            ...
            <tbody>
                <?php while ($anime = mysqli_fetch_assoc($result)): ?>
                    <tr>
                        <td><?php echo htmlspecialchars($anime['titulo']); ?></td>
                        <td><?php echo htmlspecialchars($anime['diretor']); ?></td>
                        <td><?php echo htmlspecialchars($anime['ano_lancamento']); ?></td>
                        <td><?php echo htmlspecialchars($anime['genero']); ?></td>
                        <td><?php echo $anime['assistido'] ? 'Sim' : 'Não'; ?></td>
                        <td><?php echo isset($anime['nota']) ? htmlspecialchars($anime['nota']) : 'N/A'; ?></td>
                        <td>
                            <a href="editar_anime.php?id=<?php echo $anime['id']; ?>">Editar</a>
                            <a href="excluir_anime.php?id=<?php echo $anime['id']; ?>">
        ...
        <div class="button-group">
            <a href="adicionar_anime.php" class="button">Adicionar Novo Anime</a>
