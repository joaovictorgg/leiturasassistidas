...
$query = "SELECT * FROM series WHERE usuario_id='$usuario_id'";
...
<head>
    ...
    <title>Gerenciar Séries - LeiturasAssistidas</title>
...
<body>
    <div class="container">
        <h1 style="color: #000">Gerenciar Séries</h1>
        <p>Nesta página, você pode visualizar, editar e excluir as séries que estão cadastradas no sistema.</p>
            ...
            <tbody>
                <?php while ($serie = mysqli_fetch_assoc($result)): ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($serie['diretor']); ?></td>
                        <td><?php echo htmlspecialchars($serie['ano_lancamento']); ?></td>
                        <td><?php echo htmlspecialchars($serie['genero']); ?></td>
                        <td><?php echo $serie['assistido'] ? 'Sim' : 'Não'; ?></td>
                        <td><?php echo isset($serie['nota']) ? htmlspecialchars($serie['nota']) : 'N/A'; ?></td>
                        <td>
                            <a href="editar_serie.php?id=<?php echo $serie['id']; ?>">Editar</a>
                            <a href="excluir_serie.php?id=<?php echo $serie['id']; ?>">
        ...
        <div class="button-group">
            <a href="adicionar_serie.php" class="button">Adicionar Nova Série</a>
